...
public class BaseTest {
   protected ThreadLocal<WebDriver> driver=new InheritableThreadLocal<>();
    ...
    public void takeScreenshot(File desttFile){
        File file = ((TakesScreenshot) getDriver()).getScreenshotAs(OutputType.FILE);
        try {
            FileUtils.copyFile(file, desttFile);
            InputStream is=new FileInputStream(desttFile);
